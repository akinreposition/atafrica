...
import foneInvestmntApp from '../../assests/foneInvestmntApp.png';
  ...
  return (
    <div id='hero-module'>
        <div className="w-full md:w-auto px-0 md:px-12 lg:px-16 mx-auto grid grid-cols-1 md:grid-cols-12 gap-x-4 lg:gap-x-8 xl:gap-x-12 gap-y-4 items-center max-w-[2024px]">
                ...
                <div className="w-auto space-y-4 justify-self-center lg:justify-self-end px-0 order-last lg:order-first">
                    <div className="space-y-8 lg:space-y-10 2xl:space-y-12 3xl:space-y-16">
                        <div className="space-y-4">
                            <h1 className="copy-h1">Get your <br/>investing eggs <br/>
                                <span className="copy-h1-alt"> in way more baskets.</span>
                            </h1>
                        </div>
                        <div className="space-y-4">
                            <p className="copy-body max-w-sm">Stocks are great for making bets, but they’re only part of the investing story. Wealthfront makes it easy to build long-term wealth with fully diversified portfolios that help you manage risk, maximize returns, and minimize taxes.</p>
                        </div>
                        <div className="flex md:items-center flex-row lg:space-x-8">
                            <a className="z-10 button_primary relative items-center justify-center rounded-md transition-all font-medium 2xl:px-6 2xl:py-3.5 px-5 py-3 copy-body button_primaryButton__1s8JK bg-blurple text-white overflow-hidden inline-flex whitespace-nowrap" href="/#">
                                Get started
                            </a>
                        </div>
                    </div>
            ...
            <div className='bg-gradient-to-l relative md:ml-40 lg:ml-72 md:content-end w-auto md:w-80 p-3'>
                <img src={foneInvestmntApp}  className="w-auto  md:w-80 justify-between mx-auto" alt="investment app"/>
            </div>

            <div  className="text-eggplant text-sm opacity-60 lg:hidden order-last pt-4 pb-12 grid grid-cols-2 col-span-full gap-y-6">
